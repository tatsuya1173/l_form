		...
		<section class="page_content">
			...
			<div class="breadcrumbs">
				<ol>
					...
					<li><a href="<?php echo esc_html( get_post_type_archive_link( 'service' ) ); ?>">車検館のサービス・メンテナンス</a></li>
					<!--php echo esc_html( get_post_type_object( 'service' )->label ); -->
					<?php }elseif(is_singular( 'shoplist' ) || is_tax( 'shoplist_cat' ) ) { /*カスタム投稿投稿タイプshoplist｜カスタムタクソノミーshoplist_cat*/ ?>
					<li><a href="<?php echo esc_html( get_post_type_archive_link( 'shoplist' ) ); ?>">店舗</a></li>
					<!--php echo esc_html( get_post_type_object( 'shoplist' )->label ); -->
