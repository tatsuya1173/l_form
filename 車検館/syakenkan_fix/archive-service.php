...
get_header(); ?>
		...
		<div class="inner">
			...
			<div class="page_title">
				<h1 class="icon_reason h1-title">車検館のサービス・メンテナンス</h1><span class="icon-ftp icon-service"><img src="<?php echo HOME; ?>img/common/icon_reason_01_pc.png" alt="握手のアイコン" srcset="<?php echo HOME; ?>img/common/icon_reason_01_pc.png 1x, <?php echo HOME; ?>img/common/icon_reason_01_sp.png 679w"></span>
			</div>
			...
			<div class="wrap">
				...
				<section id="sec_01">
					<h4 class="title bg_green"><img src="<?php echo HOME; ?>img/service/sublead_01_pc.gif" alt="車検館のサービス・メンテナンス" srcset="<?php echo HOME; ?>img/service/sublead_01_pc.gif 1x, <?php echo HOME; ?>img/service/sublead_01_sp.gif 679w"></h4>
