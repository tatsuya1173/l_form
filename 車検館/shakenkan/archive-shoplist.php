...
get_header(); ?>
		...
		<div class="inner">
			...
			<div class="page_title">
				<h1 class="h1-title">店舗一覧</h1><span class="shop-img sp-shop-img icon-shop"><img src="<?php echo HOME; ?>img/common/icon_shopinfo_01_pc.png" alt="店舗のアイコン" srcset="<?php echo HOME; ?>img/common/icon_shopinfo_01_pc.png 1x, <?php echo HOME; ?>img/common/icon_shopinfo_01_sp.png 679w"></span>
			</div>
