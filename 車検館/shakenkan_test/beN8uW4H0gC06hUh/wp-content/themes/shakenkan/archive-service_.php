...
get_header(); ?>
		...
		<div class="inner">
			...
			<div class="page_title">
				<h1 class="icon_reason">車検館が選ばれる理由<span class="icon"><img src="<?php echo HOME; ?>img/common/icon_reason_01_pc.png" alt="握手のアイコン" srcset="<?php echo HOME; ?>img/common/icon_reason_01_pc.png 1x, <?php echo HOME; ?>img/common/icon_reason_01_sp.png 679w"></span></h1>
			</div>
