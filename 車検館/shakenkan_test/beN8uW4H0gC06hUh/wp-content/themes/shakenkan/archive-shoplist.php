...
get_header(); ?>
		...
		<div class="inner">
			...
			<div class="page_title">
				<h1>店舗一覧<span class="icon"><img src="<?php echo HOME; ?>img/common/icon_shopinfo_01_pc.png" alt="店舗のアイコン" srcset="<?php echo HOME; ?>img/common/icon_shopinfo_01_pc.png 1x, <?php echo HOME; ?>img/common/icon_shopinfo_01_sp.png 679w"></span></h1>
			</div>
